...
class TestSafetyShield:
  ...
  def test_getRobotReachCapsules(self, shield):
    ...
    assert(abs(robot_caps[0][6] - 0.128755148876288) <= eps)
    print("-----") 
    ...
    assert(abs(robot_caps[1][6] - 0.135477093612307) <= eps)
    print("-----")
    ...
    assert(abs(robot_caps[2][6] - 0.123147121411940) <= eps)
    print("-----")
    ...
    assert(abs(robot_caps[3][6] - 0.132674969625049) <= eps)
    print("-----")
    ...
    assert(abs(robot_caps[4][6] - 0.127657916394952) <= eps)
    print("-----")
    ...
    assert(abs(robot_caps[5][6] - 0.046806563054797) <= eps)
