...
if __name__ == "__main__":
    ...
    def toggle_object_in_hand():
        rsenv.sim.model.eq_active[0] = int(not rsenv.sim.model.eq_active[0])

    from human_robot_gym.environments.manipulation.human_robot_handover_cartesian_env import (
        HumanRobotHandoverPhase
    )

    def progress_phase():
        rsenv.handover_phase = HumanRobotHandoverPhase(rsenv.handover_phase.value + 1)
    ...
    kb_agent.add_keypress_callback(glfw.KEY_H, lambda *_: progress_phase())
