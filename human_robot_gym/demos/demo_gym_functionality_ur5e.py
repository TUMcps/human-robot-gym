...
if __name__ == "__main__":
    ...
    raise NotImplementedError("The UR5e robot is not yet supported.\
        The reason for this is that the robosuite model of the UR5e robot\
        does not match the URDF in\
        https://github.com/culurciello/pybullet_ur5_gripper/blob/master/robots/urdf/ur5e.urdf")
    ...
    for i_episode in range(20):
        ...
        for t in range(t_max):
            ...
            goal = np.zeros_like(env.desired_goal)
            goal[1] = -np.pi
            goal[5] = np.sin(0.08 * t)
