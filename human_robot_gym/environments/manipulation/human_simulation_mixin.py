...
class HumanSimulationMixin:
    ...
    def _setup_human_simulation_methods(self):
        ...
        self._reset_collision_info = HumanEnv._reset_collision_info.__get__(self, type(self))
        self._update_collision_info = HumanEnv._update_collision_info.__get__(self, type(self))
        ...
        self._check_vel_safe = HumanEnv._check_vel_safe.__get__(self, type(self))
