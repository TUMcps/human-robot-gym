"""
Gripper for Franka's Panda (has two fingers) with qpos_range attribute for human-robot-gym.
"""
import numpy as np
...
class PandaGripper(PandaGripperBase):
    ...
    Includes qpos_range attribute for human-robot-gym compatibility.
    """
